var rule = {
    ...
    url: '/App/IndexList/indexList', //   homeUrl: 'http://124.222.116.5/homedata/home.json',
    ...
    lazy: $js.toString(() => {
        ...
        function Decrypt(word, key, iv) {
            ...
            let decrypt = CryptoJS.AES.decrypt({
                ...
                iv: iv, mode: CryptoJS.mode.CBC, // 使用CBC模式
        ...
        var request_key = JSON.stringify({
            "domain_type": "8", "vod_id": vod_id, "type": "play", "resolution": resolution, "vurl_id": vurl_id
        }); //log(request_key)
        ...
        var html = fetch('https://api.8utdtcq.com/App/Resource/VurlDetail/showOne', {
            ...
            }, body: body, method: 'POST', rejectCoding: true
        }); //log(html)
        ...
        input = {
            url: url, parse: 0, header: rule.headers
        }
        setResult(d)
    }), //   推荐: $js.toString(() => {
    //     let d = [];
    ...
    一级: $js.toString(() => {
        ...
        function gethtml(u, body, headers) {
            var hd = fetch(u, {
                headers: headers, body: body, method: 'POST', rejectCoding: true
            });
    ...
    二级: $js.toString(() => {
        ...
        var request_key3 = JSON.stringify({
            "vurl_cloud_id": "2", "vod_d_id": vod_id
        }); //log(request_key3)
