...
var rule = {
    ...
    timeout: 5000, //class_name: '番剧&国创&电影&电视剧&纪录片&综艺&全部&追番&追剧&时间表',
        ...
        try {
            ...
            if (bata.url.includes("bilibili")) {
                input = {
                    ...
                    url: bata.url,
                    jx: 1,
                    danmaku: "https://api.danmu.icu/?ac=dm&url=" + input.split("?")[0] + input.split("?")[1]
                };
            } else {
                input = {
                    parse: 0,
                    url: input.split("?")[0],
                    jx: 1,
                    danmaku: "https://dm.vidz.asia/?ac=dm&url=" + input.split("?")[0] + input.split("?")[1]
                };
            }
        } catch {
            input = {
    ...
    二级: $js.toString(() => {
        ...
        ja.forEach(function (tmpJo) {
            ...
            let cid = tmpJo["cid"];
            let link = tmpJo["link"];
            let part = tmpJo["show_title"].replace("#", "-");
